      ...
      <section id="contacts_2" className="contacts_2">
        <div className="contacts_left_sides">
          <p>Официальный дистрибьютер продукции GST в России.</p>
           ...
           {
           infoContact.map(({id,title,desc}:Contactdetails)=><div key={id} className="infoContact">
            <p>{title}:</p>
            <p>{desc}</p>
           </div>)
           }
        ...
        <div className="contacts_right_sides">
          <div className="box_contact">
              ...
              <input type="text" placeholder="Phone number*" maxLength={13} defaultValue={"+998"} onChange={checkPhoneNumber}/>
              {!phoneNumberCheck ? "":<input type="text" placeholder="Введите код *"/>}
              
              <input type="text" placeholder="Email*"/>
              <input type="text" placeholder="Company Name*"/>
              <textarea name="your message" cols="40" rows="10" placeholder="Question*"></textarea>
